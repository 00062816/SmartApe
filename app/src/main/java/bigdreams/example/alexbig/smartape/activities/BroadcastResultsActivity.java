...
public class BroadcastResultsActivity extends AppCompatActivity implements DataReceivedListener {
    ...
    protected void onCreate(Bundle savedInstanceBundle) {
        ...
        setContentView(bigdreams.example.alexbig.smartape.R.layout.broadcast_results_activity);

        listView = findViewById(bigdreams.example.alexbig.smartape.R.id.broadcast_resultListView);
        textView = findViewById(bigdreams.example.alexbig.smartape.R.id.broadcast_resultTextView);
    ...
    public void onDataReceived(MessageWrapper messageWrapper) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                textView.setText(getString(bigdreams.example.alexbig.smartape.R.string.text_average)+": "+average);
            }
        });
    }
